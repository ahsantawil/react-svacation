...
import IconsTraveler from 'assets/images/icons/icons_traveler.svg';
import IconsTreasure from 'assets/images/icons/icons_treasure.svg';
import IconsCities from 'assets/images/icons/icons_cities.svg';
        ...
        <section className="container pt-4">
            <div className="row align-items-center">
                <div className="col-auto pr-5" style={{ width: 530 }}>
                    ...
                    <p className="mb-4 font-weight-light text-grey-500 w-75" style={{lineBreak:'170%'}}>
                        We provide what you need to enjoy your holiday with family.
                        Time to make another memoriable moments.
                    </p>
